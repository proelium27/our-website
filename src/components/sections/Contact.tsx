...
const points = [
  "See exactly what your site could look like before spending a dollar",
  "Delivered in 3–5 business days, custom to your business",
  "No credit card, no commitment, no sales call",
];
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2">
          ...
          <FadeInUp>
            <div>
              ...
              <h2 className="mb-4 text-balance [font-family:var(--font-display)] text-[clamp(1.75rem,4vw,2.5rem)] font-bold leading-tight tracking-tight text-white">
                See What Your Site Could Look Like — Free.
              </h2>
              ...
              <ul className="flex flex-col gap-4">
                {points.map((pt, i) => (
                  <FadeInUp key={pt} delay={0.1 + i * 0.1}>
          ...
          <FadeInUp delay={0.15}>
            ...
            >
              {submitted ? (
                <div className="flex flex-col items-start gap-4 py-4" aria-live="polite">
